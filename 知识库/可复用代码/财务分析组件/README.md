...
> 版本：v1.0  
> 最后更新：2026-05-04  
> 来源项目：一键财报分析 v1.1、财务工具箱 v1.5、学创杯辅助软件 v2.2
...
| 组件 | 文件 | 行数 | 复用价值 | 说明 |
|------|------|------|----------|------|
| **财务比率计算** | `ratios.py` | 138 | ⭐⭐⭐⭐⭐ | 5 大类 15+ 财务指标 |
| **行业标准数据库** | `industry.py` | 142 | ⭐⭐⭐⭐⭐ | 8 大行业标准值 |
| **财报解析引擎** | `parser.py` | 296 | ⭐⭐⭐⭐ | PDF/Excel 财报自动解析 |
| **格式化工具** | `formatters.py` | 69 | ⭐⭐⭐ | 货币/百分比/数字格式化 |
| **验证工具** | `validators.py` | 77 | ⭐⭐⭐ | 数据验证与表单校验 |
| **数据库工具** | `database.py` | 311 | ⭐⭐⭐⭐ | SQLite 数据库管理 |
| **可视化组件** | `visualization.py` | 220 | ⭐⭐⭐⭐⭐ | 雷达图/趋势图/仪表盘 |
| **会话管理** | `session_manager.py` | 240 | ⭐⭐⭐⭐ | Streamlit 状态管理 |
